...
/**
 * 
 * @param {!function} onClose - a function that disables the modal Ageno
 * @returns Modal Ageno with content passed as children. In the mobile version, it automatically includes Header.
 */
